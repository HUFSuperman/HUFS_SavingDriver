_base_ = [
    '../../../_base_/models/tsn_mobileone_s4.py', '../../../_base_/schedules/adam_20e.py',
    '../../../_base_/default_runtime.py'
]

# _base_설명 :tsn_mobileone_s4 backbone 모델 사용, schedules/adam 20epoch optimizer 사용
...
# runtime settings
work_dir = './work_dirs/tsn_moblieone_s4_1x1x8_20e_Dassult/'
